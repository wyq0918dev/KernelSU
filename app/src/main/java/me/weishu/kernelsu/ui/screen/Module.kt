        ...
        LazyColumn(
            ...
            items(items = viewModel.embeddedModuleList) { module ->
                ...
                ModuleItem(
                    ...
                    onSettings = {
                        when (module.id) {
                            EmbeddedModules.KernelSU.id -> navigator.navigate(HomeScreenDestination) {
                            ...
                            EmbeddedModules.EcosedKit.id -> navigator.navigate(
                    ...
                    isEmbedded = true,
                    isSwitchable = module.switchable,
                    isChecked = isChecked,
                    updateUrl = "",
                    onUninstall = {},
                    onCheckChanged = {
                        scope.launch {
                            ...
                            if (success) {
                                ...
                                snackBarHost.showSnackbar(
                                    message = message.format(module.name)
                                )
                            }
                        }
                    },
            ...
            when {
                !viewModel.isOverlayAvailable -> item {
                    WarningCard(
                        message = stringResource(
                            id = R.string.module_overlay_fs_not_available
                        )
                    )
                }

                viewModel.moduleList.isEmpty() -> item {
                    WarningCard(
                        message = stringResource(
                            id = R.string.module_empty
                        ),
                ...
                else -> items(items = viewModel.moduleList) { module ->
                    ...
                    ModuleItem(
                        ...
                        onUpdate = {
                            scope.launch {
                                onModuleUpdate(
                                    module = module,
                                    changelogUrl = updatedModule.third,
                                    downloadUrl = updatedModule.first,
                                    fileName = "${module.name}-${updatedModule.second}.zip"
                                )
                            }
                        }
                    )
